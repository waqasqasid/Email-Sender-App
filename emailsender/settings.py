...
def send_email(request):
    ...
    recipient_list = ["ahsan.siddiqui@alnafi.edu.pk"]  # Replace with the recipient's email
...
SECRET_KEY = 'django-insecure-6y+bl9jyz!fx2=bytn=dk616c!%mbc)7yrx*h@8wcdx3ci53bm'
...
EMAIL_PORT = 587               # Port for secure communication
EMAIL_USE_TLS = True           # Use TLS for security
EMAIL_HOST_USER = config('EMAIL_HOST_USER')  # Replace with your email address
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD')   # Replace with your email's password



# Redirect after login/logout
LOGIN_REDIRECT_URL = '/login/'  # URL to redirect to after login
